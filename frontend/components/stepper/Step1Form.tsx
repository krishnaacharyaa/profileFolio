        ...
        <FormItem className="m-2">
          ...
          <FormControl>
            <Controller
              name="basics.phone"
              control={control}
              render={({ field }) => <Input {...field} type="text" placeholder="1234567890" />}
            />
          </FormControl>
        ...
        <FormItem className="m-2">
          ...
          <FormControl>
            <Controller
              ...
              control={control}
              render={({ field }) => <Input {...field} type="text" placeholder="800900" />}
            />
          </FormControl>
          <FormMessage className="text-red-500">
        ...
        <FormItem className="m-2">
          ...
          <FormControl>
            <Controller
              ...
              control={control}
              render={({ field }) => <Input {...field} type="text" placeholder="Bengaluru" />}
            />
          </FormControl>
          <FormMessage className="text-red-500">
        ...
        <FormItem className="m-2">
          ...
          <FormControl>
            <Controller
              ...
              control={control}
              render={({ field }) => <Input {...field} type="text" placeholder="IN" />}
            />
          </FormControl>
          <FormMessage className="text-red-500">
            {errors.basics?.location?.countryCode?.message}
          </FormMessage>
        </FormItem>
      </div>
