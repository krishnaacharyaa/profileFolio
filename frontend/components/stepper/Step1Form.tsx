...
const hasProfilesErrors = Array.isArray(profiles) &&
...
const hasLanguagesErrors = Array.isArray(languages) &&
  languages.some(language =>
    language?.language?.message ||
    language?.fluency?.message
  );

// Check if there are any errors in the Interests fields
const interests = errors?.basics?.interests;
const hasInterestsErrors = Array.isArray(interests) &&
  interests.some(interest =>
    interest?.name?.message ||
    (interest?.keywords?.some((keyword:any) => keyword?.message))
  );
