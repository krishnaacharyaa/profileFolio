...
const Step4Form = () => {
  ...
  return (
    <div className="flex flex-col w-full">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          onSelect={(date) => {
                            date &&
                              setValue(`projects.projectsArr.${index}.startDate`, new Date(date));
                          }}
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          onSelect={(date) => {
                            date &&
                              setValue(`projects.projectsArr.${index}.endDate`, new Date(date));
                          }}
                          disabled={(date) => date > new Date() || date < new Date('1900-01-01')}
                          initialFocus
                        />
      ...
      <Button type="button" onClick={handleAddProject} className="mt-2">
        Add Project
      </Button>
      ...
      {skillFields.map((item, index) => (
        <div key={item.id}>
          <div className="grid grid-cols-3 w-full mb-4">
            ...
            <Button type="button" onClick={() => handleRemoveSkill(index)} className="mt-2">
              Remove
            </Button>
          </div>
        </div>
      ))}
      <Button type="button" onClick={handleAddSkill} className="mt-2">
        Add Skill
      </Button>
    </div>
  );
