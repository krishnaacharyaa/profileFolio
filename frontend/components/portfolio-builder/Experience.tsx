  ...
  return (
    <section className="p-8 bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="relative">
        {/* Vertical line */}
        <div
          className="absolute left-0 top-0 bottom-0 w-0.5 bg-indigo-300"
          style={{ left: '15px' }}
        ></div>
        ...
        {companies?.map((job, index) => (
          ...
          >
            <div
              className="absolute left-0 w-8 h-8 bg-indigo-500 rounded-full border-4 border-white"
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-3">june-2024 to present</p>
