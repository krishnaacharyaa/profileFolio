            ...
            <div className=" display-flex p-2  space-y-3 rounded-xl  ">
              <div className="  bg-gray-100">
                <button
                  ...
                  className="w-full py-2 px-4 border border-gray-300 rounded hover:bg-slate-400 transition duration-200"
                >
                  Template 1
                  <img
                    src="/svg/Preview1.png"
                    alt="PREVIEW_IMAGE"
                    width={300}
                    height={300}
                    onClick={() => setSelectedTemplate('template1')}
