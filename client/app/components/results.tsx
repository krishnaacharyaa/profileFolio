...
import { Share2, Copy, Twitter, MessageCircle, RotateCcw, TrendingUp, AlertTriangle, Zap, Target, Brain } from 'lucide-react';
...
const ResultsPage = () => {
  const [result, setResult] = useState<RoastAnalysis | null>(null);
    ...
    setTimeout(() => {
      setResult({
        ...
        whats_not_terrible: [
          ...
          "Has attended more than zero meetings",
        ...
        red_flags: [
          ...
          "Resume reads like a ChatGPT generated template"
        ],
        roast: "Your resume screams 'I learned to code from YouTube tutorials and never left the comfort zone.' You're basically a human CRUD operation with commitment issues."
      });
      setIsLoading(false);
    }, 3000);
  }, []);
  ...
  const shareOnTwitter = () => {
    const text = `I just got roasted by AI and I'm ${result?.ai_risk_percentage}% replaceable 💀 Can you do worse?`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        >
          ...
          >
            {result?.name ? `${result.name}, prepare for impact...` : "Brace yourself..."}
          </motion.p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="relative inline-block mb-6">
              <svg className="h-48 w-48 transform -rotate-90" viewBox="0 0 100 100">
                <circle
                  cx="50"
                  cy="50"
                  r="40"
                ...
                <motion.circle
                  ...
                  animate={{ 
                    strokeDasharray: `${result!.ai_risk_percentage * 2.512} 251.2`,
                  }}
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  >
                    {result!.ai_risk_percentage}%
                  </motion.div>
                  <div className="text-gray-400 font-semibold">AI Replaceable</div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-orange-300 mb-4">The Roast:</h3>
        ...
        >
          {[
            ...
            { 
              value: `${result!.buzzword_bingo}/10`, 
        ...
        >
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
            ...
            <ul className="space-y-4">
              {result!.whats_not_terrible.map((strength, index) => (
                <motion.li 
                  key={index} 
        ...
        <AnimatePresence>
          {showShareOptions && (
            ...
            >
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Share the carnage</h3>
        ...
        <motion.p
          ...
          transition={{ delay: 4 }}
        >
          *Results may cause existential crisis, career pivots, or sudden urges to learn actual skills
        </motion.p>
      </div>
    </div>
  );
