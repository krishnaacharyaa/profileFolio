...
// 						Upload your resume. Let me judge you.
// 					</p>
// 				</motion.div>
...
// 			initial={{ opacity: 0, y: 20 }}
// 			animate={{ opacity: 1, y: 0 }}
// 			className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 p-4"
// 		>
// 			<div className="max-w-2xl mx-auto py-8">
// 				<motion.div
// 					initial={{ scale: 0.9 }}
// 					animate={{ scale: 1 }}
// 					className="bg-gray-800/80 backdrop-blur rounded-2xl p-8 mb-6"
// 				>
...
// 							</div>
// 							<div className="text-gray-300 text-sm">Replaceable</div>
// 						</div>
// 						<div className="bg-gray-700/50 rounded-lg p-4 text-center">
// 							<div className="text-2xl font-bold text-blue-400">
// 								{analysisResult?.techScore}/10
// 							</div>
// 							<div className="text-gray-300 text-sm">Tech Score</div>
// 						</div>
// 						<div className="bg-gray-700/50 rounded-lg p-4 text-center">
// 							<div className="text-2xl font-bold text-yellow-400">
// 								{analysisResult?.gptOverlap}%
// 							</div>
// 							<div className="text-gray-300 text-sm">GPT Overlap</div>
// 						</div>
// 					</div>
...
// 							🔥 Savage Insight:
// 						</h3>
// 						<p className="text-gray-300">{analysisResult?.savageInsight}</p>
// 					</div>

// 					<div className="bg-gray-700/30 rounded-lg p-4 mb-6">
// 						<h3 className="text-white font-semibold mb-3">
// 							How to be less replaceable:
// 						</h3>
...
// 						whileTap={{ scale: 0.95 }}
// 						className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 rounded-lg font-semibold text-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-200 flex items-center justify-center gap-2"
// 					>
// 						<Share2 className="w-5 h-5" />
// 						Now roast your friend →
// 					</motion.button>
// 				</motion.div>
...
// 					}}
// 					className="text-gray-400 hover:text-white transition-colors text-center w-full"
// 				>
